//if array contains 1 then conceutive elements diff should not be 1 (when sorted)
//if array does not contains 1 then its always possible to make it equal
...
void solve() {
    ...
    //concecutive diff should not be 1
    srt(a);
    for(int i = 0 ; i < n-1 ; i++){
        if(a[i+1]-a[i] == 1){
            cout<<"NO\n";
